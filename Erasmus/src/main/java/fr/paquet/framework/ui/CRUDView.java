...
public class CRUDView extends AbsoluteLayout implements Property.ValueChangeListener, Handler, ClickListener, ErasmusView {
	...
	private void buildView() {
		setSizeFull();
		GridBasedCrudComponent<ErasmusItem> crud = new GridBasedCrudComponent<ErasmusItem>(entityClass);
		FormLayout layout=new FormLayout();
		layout.addComponent(crud);
		
		ErasmusContainer container= new ErasmusContainer(entityClass);
		...
		crud.setCrudFormFactory(new ErasmusCrudFormFactory(entityClass));
