...
public class ErasmusCrudFormFactory extends GridLayoutCrudFormFactory<ErasmusItem> {
	...
	private static List<PropertyInfo> getColumnsInfo(Class<ErasmusItem> domainType) {
	...
	public ErasmusCrudFormFactory(Class<ErasmusItem> domainType) {
	...
	@Override
	public Component buildNewForm(CrudOperation operation, ErasmusItem domainObject, boolean readOnly,
		...
		BeanFieldGroup fieldGroup = new ErasmusBeanFieldGroup(domainObject.getClass());
